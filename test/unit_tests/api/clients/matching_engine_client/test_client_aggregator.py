""" Unit test module for matching engine client aggregator. """
...
class ClientAggregatorTestSuite(unittest.TestCase):
  """ Unit test suite for ClientAggregator. """
  ...
  def test_should_return_mock_client_when_match_service_disabled(
      self, mock_match_service_client, match_service_client,
      config_facade) -> None:
    ...
    client_aggregator = ClientAggregator(config_facade,
                                         mock_match_service_client,
  ...
  @patch('src.api.clients.matching_engine_client.client.MatchServiceClient')
  @patch('src.api.clients.matching_engine_client.client.MockMatchServiceClient')
  def test_should_return_match_service_client_when_match_service_enabled(
      self, mock_match_service_client, match_service_client,
      config_facade) -> None:
  ...
  @patch('src.api.clients.matching_engine_client.client.MatchServiceClient')
  @patch('src.api.clients.matching_engine_client.client.MockMatchServiceClient')
  def test_should_not_reinstantiate_client_when_created(
      self, mock_match_service_client, match_service_client,
      config_facade) -> None:
    config_facade.is_match_service_enabled.return_value = False
    client_aggregator = ClientAggregator(config_facade,
