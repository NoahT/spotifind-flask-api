""" Integration test module for matching engine client. """
import unittest
...
class MatchingEngineClientTestSuite(unittest.TestCase):
  """ Integration test suite for MatchingEngineClient. """
  ...
  def test_should_return_match_response_for_singular_reco(self) -> None:
    match_request = {
        'query': [0.762, 0.213, 10, -14.68, 1, 0.128, 0.52, 0, 0.0668, 0.105],
        'num_recos': 1
    }
    match_response = self.match_service_client.get_match(
