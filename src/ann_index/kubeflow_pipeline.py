...
def pipeline(peering_range: str, region: str, project_number: str, environment: str, version: str, machine_type: str, min_replica: int, max_replica: int):
    deploy_component = kfp.components.load_component_from_file('./components/pipeline_deploy.yaml')
    deploy_component_output = deploy_component(peering_range, region, project_number, environment, version, machine_type, min_replica, max_replica)
