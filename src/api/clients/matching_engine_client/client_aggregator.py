"""
  Aggregator module for match service client across different environments.
"""
from . import client
...
class ClientAggregator():
  """ Aggregator class for environment-based match service client. """

  def __init__(self, config_facade: ConfigFacade,
               mock_match_service_client: client.Client,
               match_service_client: client.Client) -> None:
